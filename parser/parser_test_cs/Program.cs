...
namespace parser_test_cs
{
	class Program
	{
		...
		private static extern int ParseAnimation(byte[] in_buffer, int in_len, byte[] out_buffer, int out_len);
		...
		static void Main(string[] args)
		{
			...
			int real_out_len = ParseAnimation(in_buff, in_buff.Length + 1, out_buff, out_buff.Length + 1);
